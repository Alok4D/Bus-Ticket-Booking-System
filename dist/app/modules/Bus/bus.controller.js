...
const createBus = (0, catchAsync_1.default)(async (req, res, next) => {
    const bus = await bus_service_1.BusService.createBus(req.body);
    (0, sendResponse_1.default)(res, { statusCode: http_status_codes_1.StatusCodes.CREATED, success: true, message: "Bus created", data: bus });
});
...
const updateBus = (0, catchAsync_1.default)(async (req, res, next) => {
    const bus = await bus_service_1.BusService.updateBus(req.params.id, req.body);
